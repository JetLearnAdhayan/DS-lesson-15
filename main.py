...
fig2 = go.Figure()
fig2.add_trace(go.Scatter(x = data_dates.index, y = data_dates["New_cases"],fill="tonexty", line_color = "blue"))
fig2.update_layout(title = "New Cases Worldwide")
fig2.write_html("Fig2.html", auto_open=True)

fig3 = go.Figure()
fig3.add_trace(go.Scatter(x = data_dates.index, y= data_dates["New_deaths"],fill="tonexty", line_color = "blue"))
fig3.update_layout(title = "New Deaths Worldwide")
fig3.write_html("Fig3.html", auto_open =True)

fig4 = go.Figure()
fig4.add_trace(go.Scatter(x = data_dates.index, y=data_dates["Cumulative_deaths"],fill = "tonexty", line_color = "red"))
